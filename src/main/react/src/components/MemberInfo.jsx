...
const MemberInfoPage = ({user, setUser}) => {
    ...
    const uploadAvatar = () => {
        ...
        fetch(`http://localhost:8000/api/members/${memberId}/avatar`, {
            ...
            .then((data) => {
                setUser((prevUser) => ({
                    ...prevUser,
                    avatar: data.data.avatarImage, // 서버에서 반환된 아바타 URL
                }));
                setFile(null);
            })
            .catch((error) => {
    ...
    const avatarFileName = avatarImagePath
    ...
    const avatarUrl =
        avatarImagePath && avatarImagePath.includes("default-avatar.png")
            ? defaultAvatarUrl
        ...
        <div className="p-6">
            ...
            >
                ...
                <button
                    ...
                    } text-white py-2 rounded-md hover:bg-blue-700`}
                    disabled={isLoading}
                >
                    {isLoading ? "수정 중..." : "수정하기"}
                </button>
